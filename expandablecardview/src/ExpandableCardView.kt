...
class ExpandableCardView @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) : LinearLayout(context, attrs, defStyleAttr) {
    ...
    override fun onFinishInflate() {
        ...
        if (cardStrokeColor != android.R.color.transparent) card_layout.strokeColor = ResourcesCompat.getColor(resources, cardStrokeColor, context.theme)
        ...
        val heightDistributedAmongAll4 = reviews.bottom / 4
        card_container.minimumHeight = heightDistributedAmongAll4
        card_header.minimumHeight = heightDistributedAmongAll4
        header_ll.minimumHeight = heightDistributedAmongAll4
        header_cl.minHeight = heightDistributedAmongAll4
